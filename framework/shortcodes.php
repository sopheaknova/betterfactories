...
function add_shortcodes_tinymce_plugin( $plugin_array) {
	$plugin_array['sp_shortcodes'] = SP_BASE_URL.'framework/tinymce/tinymce.js';
...
function sp_admin_scripts( $hook ) {
	...
	if( $hook == 'post.php' || $hook == 'post-new.php' ) {
		wp_register_script( 'tinymce_scripts', SP_BASE_URL . 'framework/tinymce/js/scripts.js', array('jquery'), false, true );
		wp_enqueue_script('tinymce_scripts');
	}
	
	//Quicktags
	wp_register_script( 'aw_quicktags', SP_BASE_URL . 'framework/tinymce/quicktags.js', array('quicktags'), false, true );
	wp_enqueue_script('aw_quicktags');
