...
class fb_likebox_widget extends WP_Widget {
	function fb_likebox_widget() {
		...
		$widget_ops = array('classname' => 'Like-box','description' => __('Facebook Like Box','sptheme'));

		$this->WP_Widget('Like-box',__('BFC - Facebook Likebox','sptheme'),$widget_ops);
...
function form( $instance ) {
    	...
    	<p>
		<label for="<?php echo $this->get_field_id( 'width' ); ?>"><?php _e('Width:', 'sptheme') ?></label>
    	...
    	<p>
		<label for="<?php echo $this->get_field_id( 'height' ); ?>"><?php _e('Height:', 'sptheme') ?></label>
    	...
    	<p>
		<label for="<?php echo $this->get_field_id( 'background' ); ?>"><?php _e('Background Color: (color code without #)', 'sptheme') ?></label>
    	...
    	<p>
		<label for="<?php echo $this->get_field_id( 'borderc' ); ?>"><?php _e('Box border Color: (color code without #)', 'sptheme') ?></label>
    	...
    	<p>
		<label for="<?php echo $this->get_field_id( 'page' ); ?>"><?php _e('Facebook Page URL:', 'sptheme') ?></label>
